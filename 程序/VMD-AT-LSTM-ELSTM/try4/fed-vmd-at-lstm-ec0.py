...
f3 = r'C:\Users\LDK\Desktop\数据\6\4-30-6.csv'     # 测试集数据
F = r"C:\Users\LDK\Desktop\da-tu\try\4-15-6_fed\1"  # 图片保存位置
f_1=r"C:\Users\LDK\Desktop\da-tu\try\4-15-6_fed\1\rmse.txt"  # print输出保存位置
N1 = 20  # LSTM训练次数
N2 = 5  # 联邦LSTM训练次数
F_N = 5  # 联邦次数
M = 5  # 训练步长
...
if __name__=="__main__":
    ...
    for i in range(F_N + 1):
        if i >= 1:
            ...
            N0 = N2
            Fed = True
            weights = AVG(params_A, params_B)
            e_weights = AVG(params_A0, params_B0)
        # A
        params_A, params_A0 = Client(f1, f3, NAME + "A")
        # B
        params_B, params_B0 = Client(f3, f1, NAME + "B")
