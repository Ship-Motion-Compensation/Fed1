...
F = r"C:\Users\刘敦康\Desktop\datu\fed"  # 图片保存位置
f_1=r"C:\Users\刘敦康\Desktop\datu\fed\rmse.txt"  # print输出保存位置
N1 = 30  # LSTM训练次数
N2 = 3  # 联邦LSTM训练次数
F_N = 5  # 联邦次数
M = 5  # 训练步长
...
def train_test(f, name, m, n):
    ...
    plt.show()
    return D01, model0, Data00[m: n], y01_2, params
...
def Client(f,ff, name, m, n):
    D01, model0, Data00, y01_2, params_A = train_test(f, name, m, n)
...
if __name__=="__main__":
    ...
    Fed = False
    # A
    params_A, params_A0, rmse_A, rmse_A0 = Client(f1, f3, NAME + "A", 3000, -1)
    # B
    params_B, params_B0, rmse_B, rmse_B0 = Client(f2, f3, NAME + "B", 0, 1000)
    ...
    for i in range(F_N):
        ...
        e_weights = AVG(A0, B0)
        # A
        params_A_1, params_A0_1, rmse_A_1, rmse_A0_1 = Client(f1, f3, NAME + "A", 3000, -1)
        # B
        params_B_1, params_B0_1, rmse_B_1, rmse_B0_1 = Client(f2, f3, NAME + "B", 0, 1000)
