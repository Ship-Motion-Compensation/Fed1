...
f1 = r'C:\Users\LDK\Desktop\数据\拼接\五_all.csv'  # A数据
f3 = r'C:\Users\LDK\Desktop\数据\拼接\五_all.csv'     # 测试集数据
F = r"C:\Users\LDK\Desktop\da-tu\try\拼接"  # 图片保存位置
f_1=r"C:\Users\LDK\Desktop\da-tu\try\拼接\rmse.txt"  # print输出保存位置
N1 = 30  # LSTM训练次数
N2 = 3  # 联邦LSTM训练次数
F_N = 5  # 联邦次数
M = 5  # 训练步长
...
def train_test(f, name):
    ...
    Data00 = data_csv_0.values.flatten()[200:]
...
def text(f, model0, name):
    ...
    Data002 = data_csv_02.values.flatten()[200:4000]
