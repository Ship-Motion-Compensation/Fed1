...
F = r"C:\Users\刘敦康\Desktop\datu\fed8"  # 图片保存位置
f_1 = r"C:\Users\刘敦康\Desktop\datu\fed8\rmse.txt"  # print输出保存位置
f_100 = r"C:\Users\刘敦康\Desktop\datu\fed8\rmse1.txt"  # print输出保存位置
N1 = 1  # LSTM训练次数
N2 = 1  # 联邦LSTM训练次数
F_N = 30  # 联邦次数
M = 5  # 训练步长
