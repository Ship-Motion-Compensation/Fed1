...
def train_test(f):
    ...
    plt.show()
    return D01, model0, Data00, y01_2
...
if __name__=="__main__":
    ...
    D01, model0, Data00, y01_2 = train_test(f1)
    D02, Data002, y02_2 = text(f3, model0)

    model1, res_1 = train_text2(D01)
    res_2 = text2(D02, model1)
