...
f1 = r'C:\Users\刘敦康\Desktop\数据\拼接\四_all_00.csv'  # A数据
f2 = r'C:\Users\刘敦康\Desktop\数据\拼接\四_all_11.csv'  # B数据
f3 = r'C:\Users\刘敦康\Desktop\数据\拼接\四_all_3.csv'
f_00 = r'C:\Users\刘敦康\Desktop\数据\拼接\四_all.csv'  # 测试集数据
F = r"C:\Users\刘敦康\Desktop\datu\fed10"  # 图片保存位置
f_1 = r"C:\Users\刘敦康\Desktop\datu\fed10\rmse.txt"  # print输出保存位置
f_100 = r"C:\Users\刘敦康\Desktop\datu\fed10\rmse1.txt"  # print输出保存位置
N1 = 1  # LSTM训练次数
N2 = 1  # 联邦LSTM训练次数
F_N = 30  # 联邦次数
M = 5  # 训练步长
...
def W_AVG(A, B, C):
    ...
    for i in range(len(weight)):
        weight[i] = ((31 / 76) * A[i] + (22 / 76) * B[i] + (23 / 76) * C[i])
    weights = weight
    return weights
...
if __name__ == "__main__":
    ...
    Fed = False
    # A
    params_A, params_A0, rmse_A, rmse_A0, rmse_A00 = Client(f1, f_00, NAME + "A", 2000, -1)
    # B
    params_B, params_B0, rmse_B, rmse_B0, rmse_B00 = Client(f2, f_00, NAME + "B", 0, 2000)

    params_C, params_C0, rmse_C, rmse_C0, rmse_C00 = Client(f3, f_00, NAME + "C", 0, 2600)
    ...
    C, C0, r_C, r_C0, r_C00 = params_C, params_C0, rmse_C, rmse_C0, rmse_C00
    ...
    CC, CC0, r_CC, r_CC0, r_CC00 = params_C, params_C0, rmse_C, rmse_C0, rmse_C00
    ...
    CCC, CCC0, r_CCC, r_CCC0, r_CCC00 = params_C, params_C0, rmse_C, rmse_C0, rmse_C00
    ...
    #     Fed = True
    #     weights = AVG(A, B, C)
    #     e_weights = AVG(A0, B0, C0)
    #     # A
    #     params_A_1, params_A0_1, rmse_A_1, rmse_A0_1, rmse_A00_1 = Client(f1, f_00, NAME + "A", 2000, -1)
    #     # B
    #     params_B_1, params_B0_1, rmse_B_1, rmse_B0_1, rmse_B00_1 = Client(f2, f_00, NAME + "B", 0, 2000)
    #
    #     params_C_1, params_C0_1, rmse_C_1, rmse_C0_1, rmse_C00_1 = Client(f3, f_00, NAME + "C", 0, 2600)
    #
    ...
    for i_w in range(F_N):
        ...
        N0 = N2
        Fed = True
        weights = W_AVG(AA, BB, CC)
        e_weights = W_AVG(AA0, BB0, CC0)
        # A
        params_AA_1, params_AA0_1, rmse_AA_1, rmse_AA0_1, rmse_AA00_1 = Client(f1, f_00, NAME + "A", 2000, -1)
        # B
        params_BB_1, params_BB0_1, rmse_BB_1, rmse_BB0_1, rmse_BB00_1 = Client(f2, f_00, NAME + "B", 0, 2000)

        params_CC_1, params_CC0_1, rmse_CC_1, rmse_CC0_1, rmse_CC00_1 = Client(f3, f_00, NAME + "C", 0, 2600)
    ...
    #     N0 = N2
    #     Fed = True
    #     weights = AVG(Aa, Bb, Cc)
    #     e_weights = AVG(Aa0, Bb0, Cc0)
    #     # A
    #     params_Aa_1, params_Aa0_1, rmse_Aa_1, rmse_Aa0_1, rmse_Aa00_1 = Client(f1, f_00, NAME + "A", 2000, -1)
    #     # B
    #     params_Bb_1, params_Bb0_1, rmse_Bb_1, rmse_Bb0_1, rmse_Bb00_1 = Client(f2, f_00, NAME + "B", 0, 2000)
    ...
    #
    #     Cc, Cc0, r_Cc, r_Cc0 = params_Cc_1, params_Cc0_1, rmse_Cc_1, rmse_Cc0_1
    #
    # print('\n', file=f00)
    #
    ...
    #     N0 = N2
    #     Fed = True
    #     weights = W_AVG(AAA, BBB, CCC)
    #     e_weights = W_AVG(AAA0, BBB0, CCC0)
    #     # A
    #     params_AAA_1, params_AAA0_1, rmse_AAA_1, rmse_AAA0_1, rmse_AAA00_1 = Client(f1, f_00, NAME + "A", 2000, -1)
    #     # B
    #     params_BBB_1, params_BBB0_1, rmse_BBB_1, rmse_BBB0_1, rmse_BBB00_1 = Client(f2, f_00, NAME + "B", 0, 2000)
    #
    #     params_CCC_1, params_CCC0_1, rmse_CCC_1, rmse_CCC0_1, rmse_CCC00_1 = Client(f3, f_00, NAME + "C", 0, 2600)
    #
    ...
    #
    #     CCC, CCC0, r_CCC, r_CCC0 = params_CCC_1, params_CCC0_1, rmse_CCC_1, rmse_CCC0_1
