...
# f1 = r'C:\Users\LDK\Desktop\数据\6\4-15-6.csv'  # A数据
# f3 = r'C:\Users\LDK\Desktop\数据\6\6-45-6.csv'     # 测试集数据
# F = r"C:\Users\LDK\Desktop\da-tu\try\4-15-6_fed\14"  # 图片保存位置
# f_1=r"C:\Users\LDK\Desktop\da-tu\try\4-15-6_fed\14\rmse.txt"  # print输出保存位置
N1 = 20  # LSTM训练次数
N2 = 2  # 联邦LSTM训练次数
F_N = 5  # 联邦次数
M = 5  # 训练步长
...
def train_test(f, name):
    ...
    plt.show()
    return D01, model0, Data00, y01_2, params
...
def Client(f,ff, name):
    D01, model0, Data00, y01_2, params_A = train_test(f, name)
    ...
    print(rmse_1, rmse_2)
    return params_A, params_A0, rmse_1, rmse_2
...
if __name__=="__main__":
    ...
    path2 = r'C:\Users\LDK\Desktop\da-tu\try\fed'
    path_list2 = os.listdir(path2)

    a = []
    for i0 in range(len(path_list1)-1):
        # f1 = os.path.join(path1, path_list1[i0])
        f3 = os.path.join(path1, path_list1[i0+1])
        ...
        for i in range(F_N + 1):
            if i >= 1:
                ...
                e_weights = AVG(A0, B0)
            # A
            params_A, params_A0, rmse_A, rmse_A0 = Client(f1, f3, NAME + "A")
            # B
            params_B, params_B0, rmse_B, rmse_B0 = Client(f3, f1, NAME + "B")

            if i == 0:
                A, A0, r_A, r_A0 = params_A, params_A0, rmse_A, rmse_A0

                B, B0, r_B, r_B0 = params_B, params_B0, rmse_B, rmse_B0
