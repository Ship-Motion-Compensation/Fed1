...
F = r"C:\Users\刘敦康\Desktop\datu\fed9"  # 图片保存位置
f_1 = r"C:\Users\刘敦康\Desktop\datu\fed9\rmse.txt"  # print输出保存位置
f_100 = r"C:\Users\刘敦康\Desktop\datu\fed9\rmse1.txt"  # print输出保存位置
N1 = 1  # LSTM训练次数
N2 = 1  # 联邦LSTM训练次数
F_N = 30  # 联邦次数
M = 5  # 训练步长
...
if __name__ == "__main__":
    ...
    for i_w in range(F_N):
        ...
        # A
        params_AA_1, params_AA0_1, rmse_AA_1, rmse_AA0_1, rmse_AA00_1 = Client(f1, f3, NAME + "A", 3000, -1)
        # B
        params_BB_1, params_BB0_1, rmse_BB_1, rmse_BB0_1, rmse_BB00_1 = Client(f2, f3, NAME + "B", 0, 1000)
    ...
    for i_nw in range(F_N):
        ...
        # A
        params_AAA_1, params_AAA0_1, rmse_AAA_1, rmse_AAA0_1, rmse_AAA00_1 = Client(f1, f3, NAME + "A", 3000, -1)
        # B
        params_BBB_1, params_BBB0_1, rmse_BBB_1, rmse_BBB0_1, rmse_BBB00_1 = Client(f2, f3, NAME + "B", 0, 1000)
